    ...
    <body>
        <div id="page">
            <div id="header">	        
	           ...
	           src="<?php echo url::base() ?>img/slate/hyves_baseline_nl.png"
	             width="61" height="33" alt="hyveslogo" /></a></h1>
                <ul id="dev-links">
	  ...
	  <div id="vertical-furniture"></div>
	    ...
	    <div id="footer-links">
            <ul>
                ...
                <li><a href="http://code.google.com/p/google-breakpad/">Breakpad Wiki</a></li>
            </ul>
	    </div>
        </div><!-- /FOOTER -->
