...
aShowStatus['busy'] = {show: 'dnd', status: 'Busy'};
aShowStatus['berightback'] = {show: 'away', status: 'Be Right Back'};
aShowStatus['away'] = {show: 'away', status: 'Away'};
aShowStatus['phone'] = {show: 'dnd', status: 'In a call'};
aShowStatus['lunch'] = {show: 'away', status: 'Out to Lunch'};
aShowStatus['offline'] = {show: 'offline', status: 'Appear Offline'};
...
_dynjsload['/Music/musicTextTemplate.tpl'] = '/precompiled/musicTextTemplate_en_GB.89231846dd7d9af6.js';
_dynjsload['/general/error_successTemplate.tpl'] = '/precompiled/error_successTemplate_en_GB.84c5d46a86a02e10.js';
_dynjsload['/relationeditor/relationEditorTemplates.tpl'] = '/precompiled/relationEditorTemplates_en_GB.3ed40c0526c4cbc4.js';
_dynjsload['/mediaorganizer/mediaOrganizerTemplates.tpl'] = '/precompiled/mediaOrganizerTemplates_en_GB.d7a8e1807dcb92dc.js';
_dynjsload['/message/messageTemplates.tpl'] = '/precompiled/messageTemplates_en_GB.954b85304d797eb1.js';
_dynjsload['/PokeMe/pokeMeDialogTemplates.tpl'] = '/precompiled/pokeMeDialogTemplates_en_GB.189351dc58b8249f.js';
_dynjsload['/rte/rteTemplates.tpl'] = '/precompiled/rteTemplates_en_GB.34712383e5dd344d.js';
_dynjsload['/hub/js/hubModeratorEditDialogTemplates.tpl'] = '/precompiled/hubModeratorEditDialogTemplates_en_GB.c59302908b8b7789.js';
_dynjsload['/reaction/reactionTemplates.tpl'] = '/precompiled/reactionTemplates_en_GB.2a5832cce4eea9b1.js';
_dynjsload['/networktool/networktoolTemplates.tpl'] = '/precompiled/networktoolTemplates_en_GB.5516e05a25d32a01.js';
_dynjsload['/Media/mediaitemTemplates.tpl'] = '/precompiled/mediaitemTemplates_en_GB.c7c52d6bb24bca69.js';
_dynjsload['/Chat/siteClientTemplates.tpl'] = '/precompiled/siteClientTemplates_en_GB.cb90ad882646de02.js';
_dynjsload['/hyvesense/2/hub_selector_templates.tpl'] = '/precompiled/hub_selector_templates_en_GB.a2eb7a3a0f629fa2.js';
_dynjsload['/feed/signalManagerTemplates.tpl'] = '/precompiled/signalManagerTemplates_en_GB.b29cbfb523e15bed.js';
_dynjsload['/gap/gapTemplates.tpl'] = '/precompiled/gapTemplates_en_GB.29c804c7ebcd88c9.js';
_dynjsload['/Media/uploadtemplates.tpl'] = '/precompiled/uploadtemplates_en_GB.55db86ec4a4fb06e.js';
_dynjsload['/FriendGroup/friendGroupDialogTemplates.tpl'] = '/precompiled/friendGroupDialogTemplates_en_GB.25b6ba7c4a0129c1.js';
_dynjsload['/Btf/btftemplates.tpl'] = '/precompiled/btftemplates_en_GB.42618e60b07fffb1.js';
...
templates.addTranslation('GENERAL_CANCEL', 'Cancel');
templates.addTranslation('GENERAL_NAVIGATION_PAGE', 'Page');
templates.addTranslation('GENERAL_NAVIGATION_PAGE_NEXT', 'Next page');
templates.addTranslation('GENERAL_NAVIGATION_PAGE_PREV', 'Previous page');
templates.addTranslation('GENERAL_SOMETHING_WENT_WRONG_RELOAD', 'Something went wrong, do you want to reload the page?');
...
templates.addTranslation('ILLEGAL_GADGET', 'This gadget isn\'t allowed yet, or something else went wrong.');
templates.addTranslation('RTE_PREVIEW_GADGET', 'Gadget');
templates.addTranslation('RTE_MSIE6_GOODGADGET', 'This gadget has been approved and will be shown on the site');
templates.addTranslation('PRINT_MEDIA_NO_RIGHT_TO_PRINT', 'Unfortunately you\'re not allowed to order this photo!');
templates.addTranslation('PRINT_ALBUM_NO_RIGHT_TO_PRINT', 'Unfortunately you can\'t order prints from this album');
templates.addTranslation('PRESENCESHOWSTATUSMENU_TITLE', 'My online status');
templates.addTranslation('GENERAL_SUBMIT', 'Send');
