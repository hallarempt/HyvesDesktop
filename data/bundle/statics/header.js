...
function setInitialPresenceCookie(value)
{
	window.settingsManager.setValue('General/chatInitialPresence', value);
}
...
function attachInitialPresenceSelector(element)
{
	...
	if(window.settingsManager.stringValue('General/chatInitialPresence')) {
		initialPresenceSelector.value = window.settingsManager.stringValue('General/chatInitialPresence');
	}
	...
	Event.observe(initialPresenceSelector, 'change', function(e) {
		...
		//set the cookie
		setInitialPresenceCookie(value);
